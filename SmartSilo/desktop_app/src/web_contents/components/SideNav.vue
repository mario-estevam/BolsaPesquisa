  ...
  <div class="sidenav" :style="sideNavStyle">
    ...
    <footer>
      ...
      <div id="team">
        <p>
          Developed by:
          <span class="link" @click="openUrl('http://github.com/yuredev')">Yure Matias</span>,
           <span class="link" @click="openUrl('https://github.com/mario-estevam')">Mario Estevam</span> and 
